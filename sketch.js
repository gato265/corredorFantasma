...
function spawnDoors()
 {
  ...
  if (frameCount % 240 === 0) {
    ...
    //cuando aparezca una puerta va a aparecer tambien un esccalador y un ivisibleblock. 
    //la pociscion de los 2 va a ser igual al de la puerta
    climber.x =door.x;
    ...
    //para que el fantasma este en el primer plano, el + se pone para que el fantasme no se pierda con la puerta  
